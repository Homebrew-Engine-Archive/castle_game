...
Palette::Palette() : mStorage(nullptr) {}

const auto paletteDeleter = [](SDL_Palette *palette) {
...
SDL_Palette &Palette::GetSDLPalette() { return *mStorage; }

bool Palette::Null() const { return !static_cast<bool>(mStorage); }

bool Palette::operator!() const { return !Null(); }
} // namespace core
