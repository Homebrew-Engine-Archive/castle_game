...
/**
 * \brief Simple descending-size ordering of surfaces.
...
/**
 * \brief This one eval layout of surfaces and call BuildAtlas.
...
/**
 * \brief And this one is just blit one surface after another with given partition.
