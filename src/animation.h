...
{
    const gm1::Collection &gm1;
    const std::vector<Frame> &frames;
    size_t position;
public:
    AnimationBuilder(const gm1::Collection &gm1, const std::vector<Frame> &frames);
...
struct Archer
{
    Archer(const gm1::Collection &gm1, const std::vector<Frame> &frames);
